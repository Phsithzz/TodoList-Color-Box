...
const TodoShow = ({todo,setTodo}) => {
  return (
    <div className="grid grid-cols-3 gap-6 ml-44 mt-6">
            {
              todo.map((t,index)=>(
                ...
                <div className={`w-56 h-32 rounded-2xl overflow-y-auto ${t.color}`} key={index}>
                  ...
                  type="button" className='fixed ml-2 pl-2 font-semibold rounded-md h-8 pr-4 cursor-pointer bg-white transition ease-in duration:400 hover:bg-black hover:text-white'>
                    Delete</button>
